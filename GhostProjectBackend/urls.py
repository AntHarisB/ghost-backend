...
urlpatterns = [
    ...
    path('api/employees/edit/<int:id>/', EmployeeUpdateView.as_view(), name='employee-update'),
    ...
    path('api/update_project/<int:id>/', ProjectUpdateView.as_view(), name='update_project'),
    path('api/delete_project/<int:id>/', ProjectDeleteView.as_view(), name='delete_project'),
