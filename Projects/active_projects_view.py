...
from .active_projects_serializer import ActiveProjectInfoSerializer
...
class ActiveProjectInfo(generics.ListAPIView):
    serializer_class = ActiveProjectInfoSerializer
